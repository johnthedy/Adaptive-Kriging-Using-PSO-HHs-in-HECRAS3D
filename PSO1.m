function [bestFitness,bestOrganism]=PSO1(ite,particle,x,beta1,beta2,nRV,xdoe,G_xdoe,mode,dmin,CP,dmodel)
%% Parameter Setting
%initial velocity
n=nRV;
...
%% Start
fitness=fobjPSO(x,xdoe,G_xdoe,beta1,mode,dmin,CP,dmodel);
